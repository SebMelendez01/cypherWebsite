        ...
        <div className="engage">
            <Card className="get-involved">
                <Card.Body>
                    ...
                    <a href='https://forms.gle/LuNA86cb6jL7gCbQ9' target="_blank" rel="noopener noreferrer"><button class="gradient-button">Get Involved</button></a>
                </Card.Body>
            </Card>
            <div className="apply-background">
                <Card className="apply">
                    <Card.Body>
                        ...
                        <a href='https://www.f6s.com/cypher-accelerator-cohort-2022/' target="_blank" rel="noopener noreferrer"><button class="white-button">Apply</button></a>
                    </Card.Body>
                </Card>
            </div>
        </div>
